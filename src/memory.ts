...
export const defaultPrompt = [
    ...
    "Your output is connected to a state machine which will perform actions based on your output.",
    ...
    "To remember stuff you will just output back the reminder to the user",
    ...
    "An example state is your memory, you can output your memory to the user as JSON",
